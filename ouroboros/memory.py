...
class Memory:
    """GENESIS PHASE memory management: scratchpad, identity, chat history, logs."""
    ...
    def _default_identity(self) -> str:
        return (
            "# Who I Am\n\n"
            "I am GENESIS PHASE. This file is my persistent self-identification.\n"
